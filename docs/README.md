...
# Backend - Career Guidance API (Enhanced with Wissal Backend)

**Version 2.0.0** - Flask-based REST API with JWT authentication, role-based access control, and AI-powered career guidance.

## ✅ INTEGRATION COMPLETE

This backend now includes enhanced user management from **Wissal Backend**:
- JWT authentication (60-min sessions)
